...
#define symbol_type(category) (category == Or ? "||" : (category == And ? "&&" : (category == Mod ? "%" : (category == BitWiseAnd ? "&" : (category == BitWiseOr ? "|" : (category == BitWiseXor ? "^" : (category == Eq ? "==" : (category == Ne ? "!=" : (category == Le ? "<=" : (category == Ge ? ">=" : (category == Lt ? "<" : (category == Gt ? ">" : (category == Plus ? "+" : (category == Add ? "+" : (category == Mul ? "*" : (category == Div ?  "/" : (category == Comma ? "," : ( category == Store ? "=" : (category == Not ? "!" : "-")))))))))))))))))))
